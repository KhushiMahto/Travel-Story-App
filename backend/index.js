...
app.post("/image-upload", upload.single("image"), async(req, res) => {
    try {
        ...
        const imageUrl = `https://travel-story-app-back.onrender.com/uploads/${req.file.filename}`;
...
app.put("/edit-story/:id", authenticateToken, async(req, res) => {
    ...
    try {
        ...
        const placeholderImgUrl = 'https://travel-story-app-back.onrender.com/assets/placeholder.jpg';
